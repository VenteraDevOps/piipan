...
namespace Piipan.Match.Func.ResolutionApi.IntegrationTests
{
    ...
    public class AddEventApiIntegrationTests : DbFixture
    {
        ...
        public async void AddEvent_SuccessInsertsEvent()
        {
            ...
            Assert.Equal("{\"invalid_match\": true, \"initial_action_taken\": null, \"invalid_match_reason\": null, \"other_reasoning_for_invalid_match\": null, \"final_disposition_date\": null}", lastEvent.Delta);
