...
namespace Piipan.Match.Func.ResolutionApi.IntegrationTests
{
    ...
    public class GetMatchesApiIntegrationTests : DbFixture
    {
        ...
        public async void GetMatches_ReturnsCorrectSchemaIfFound()
        {
            ...
            var expected = "{\"data\":[{\"dispositions\":[{\"initial_action_taken\":null,\"invalid_match_reason\":null,\"other_reasoning_for_invalid_match\":null,\"final_disposition_date\":null,\"state\":\"ea\"},{\"initial_action_taken\":null,\"invalid_match_reason\":null,\"other_reasoning_for_invalid_match\":null,\"final_disposition_date\":null,\"state\":\"bb\"}],\"initiator\":\"ea\",\"match_id\":\"ABC\",\"created_at\":" + JsonConvert.SerializeObject(createdDates[0]) + ",\"participants\":[{\"case_id\":\"GHI\",\"participant_closing_date\":\"2021-02-28\",\"participant_id\":\"JKL\",\"recent_benefit_issuance_dates\":[{\"start\":\"2021-03-01\",\"end\":\"2021-03-31\"}],\"state\":\"bb\"},{\"case_id\":\"ABC\",\"participant_closing_date\":null,\"participant_id\":\"DEF\",\"recent_benefit_issuance_dates\":[],\"state\":\"ea\"}],\"states\":[\"ea\",\"bb\"],\"status\":\"open\"}," +
                "{\"dispositions\":[{\"initial_action_taken\":null,\"invalid_match_reason\":null,\"other_reasoning_for_invalid_match\":null,\"final_disposition_date\":null,\"state\":\"ea\"},{\"initial_action_taken\":null,\"invalid_match_reason\":null,\"other_reasoning_for_invalid_match\":null,\"final_disposition_date\":null,\"state\":\"bb\"}],\"initiator\":\"ea\",\"match_id\":\"DEF\",\"created_at\":" + JsonConvert.SerializeObject(createdDates[1]) + ",\"participants\":[{\"case_id\":\"123\",\"participant_closing_date\":\"2021-02-28\",\"participant_id\":\"456\",\"recent_benefit_issuance_dates\":[{\"start\":\"2021-03-01\",\"end\":\"2021-03-31\"}],\"state\":\"bb\"},{\"case_id\":\"789\",\"participant_closing_date\":null,\"participant_id\":\"012\",\"recent_benefit_issuance_dates\":[],\"state\":\"ea\"}],\"states\":[\"ea\",\"bb\"],\"status\":\"open\"}]}";
