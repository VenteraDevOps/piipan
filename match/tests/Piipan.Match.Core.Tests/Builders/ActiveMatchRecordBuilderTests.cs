...
namespace Piipan.Match.Core.Tests.Builders
{
    public class ActiveMatchRecordBuilderTests
    {
        ...
        public void SetMatch_SetsJsonfields()
        {
            ...
            Assert.Equal("{\"match_id\":null,\"state\":null,\"case_id\":\"XYZ\",\"participant_id\":\"TUV\",\"participant_closing_date\":null,\"recent_benefit_issuance_dates\":[],\"vulnerable_individual\":null,\"match_url\":null,\"match_creation\":\"No Match Found\"}", record.Data);
