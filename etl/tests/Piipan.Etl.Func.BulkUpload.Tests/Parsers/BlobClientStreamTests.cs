...
namespace Piipan.Etl.Func.BulkUpload.Tests.Parsers
{
    public class BlobClientStreamTests
    {
        ...
        public void GetBlob_TestBlob()
        {
            ...
            // Arrange
            var blobClientStream = new BlobClientStream();
            Environment.SetEnvironmentVariable("BlobStorageConnectionString", "DefaultEndpointsProtocol=https;EndpointSuffix=core.windows.net;AccountName=test;AccountKey=dr60GUR5mGtodn3KTot4sLIYzB8qKbs9z5Ync5lVy0hOtnr4UFf/mjGFTHhT+Ef0hfGr5kmqjHCq+AStap+0ZA==");
